...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            print(f'User info registered: {user.first_name} ')
            ...
            # assign the user to the userprofile
                ...
                if is_cart_item_exists:
                    ...
                    for pr in product_variation:
                        if pr in ex_var_list:
                            ...
                            # increase quantity
                            item.quantity += 1  
                            # assign current user to cart item(s)
                            item.user = user
                            item.save()
...
def change_password(request):
    if request.method == 'POST':
        ...
        new_password  = request.POST['create_password']
        confirm_password = request.POST['confirm_password']
...
def order_detail(request, order_id):
    ...
    # begin query to get order product details
